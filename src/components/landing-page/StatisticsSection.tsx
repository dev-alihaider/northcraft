  ...
  return (
    <>
      <div className="bg-darkGray overflow-x-hidden">
            ...
            <div className="pt-5 sm:flex grid large:px-24 md:px-16 sm:px-8 md:pt-16 sm:pt-8 sm:gap-6 max-w-full sm:justify-start justify-center">
              {statistics.map((stat, index: number) => (
                <div className="flex items-center gap-2" key={index}>
                  <span className="font-semibold text-5xl text-blue">
                    {stat.value}
                  </span>
        ...
        <div
          className="grid lg:grid-cols-5  md:grid-cols-5 w-full md:px-0 px-5"
          ref={ref}
        >
              ...
              <div className="font-semibold sm:p-4 block justify-center">
                ...
                <div className="sm:pr-16 mt-3 large:mt-10 lg:mt-5">
                  <p className="large:text-lg sm:text-base text-sm sm:text-left text-center font-normal">
                    ...
                    the industry for over 12 years. Our contractors have a
                    wealth of knowledge and skills that they have acquired over
                    the years, making them experts in their field.
                    <br />
                    <br />
