  ...
  return (
    <div className="bg-blue">
      <div className="lg:px-28 sm:px-16 ">
        <div className="grid lg:px-28 sm:px-16 sm:grid-cols-4 grid-cols-1 sm:gap-6 pt-10 pb-2 px-4 text-darkGray font-medium lg:text-xl text-sm sm:overflow-auto overflow-hidden">
          {steps.map(({ title }, index: number) => (
            ...
            >
              ...
              <img
                src={blackDot.src}
                alt="dot"
                className="w-9 h-9 sm:-ml-0 -ml-[19px] sm:-mb-0 -mb-2"
              />
            </div>
          ))}
        </div>
      ...
      <div className="flex sm:flex-row flex-col items-center sm:pt-16 py-2 large:px-28 lg:px-20 sm:px-12 px-6">
        <div className=" font-semibold large:text-5xl text-4xl sm:text-left text-center sm:w-1/3 ">
          Featured Project
        </div>
