      ...
      >
        ...
        >
          <div className="md:px-28 sm:px-20 py-48 px-6 text-white">
            ...
            <div className="pt-16 ">
              <Link href="/service">
                <Button className="transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg flex items-center gap-2 sm:py-4 py-2 sm:px-6 px-4 rounded-xl bg-blue text-darkGray sm:text-2xl text-xl font-medium">
