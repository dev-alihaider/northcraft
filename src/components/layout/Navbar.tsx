        ...
        <>
            <nav className="flex relative sm:h-36 h-28 items-center bg-opacity-70 backdrop-blur bg-darkGray w-full top-0 sm:sticky z-50">
                ...
                <div className="hidden sm:flex lg:pr-28 md:pr-12 sm:pr-8">
                    <Button
                        className="transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg py-2 whitespace-nowrap px-4 sm:py-3 sm:px-4 md:py-4 md:px-6 rounded-xl bg-blue text-darkGray lg:text-2xl font-medium">
