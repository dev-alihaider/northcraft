        ...
        <div className="bg-darkGray ">
            ...
            <div className="lg:px-28 lg:pt-12 md:px-16 md:pt-6 px-8 pt-3">
                <div className="lg:flex items-center w-full">
                    <h1 className="font-unlock text-white font-normal text-4xl"> NORTHCRAFT</h1>
                    <div className="ml-auto items-center sm:flex sm:pt-0 pt-2">

                        <p className="font-normal lg:text-xl md:text-base text-sm text-white pr-2">Subscribe To Our
                            Newslatter :</p>
                    ...
                    <div className=" lg:col-span-3 md:col-span-4 col-span-8">
                        ...
                        <p className="font-normal text-sm leading-5">We have the confidence to provide the best service
                            for you,
                            with
                            the support of Professional and Certified HR that we currently have and the high-quality
                            materials we use and structured work techniques, we will be able to realize timely
                            completion of
                            work.</p>
                    </div>
                    <div className=" lg:col-span-2 md:col-span-4 col-span-8">
                        ...
                        <p className="font-normal text-sm leading-6">
                            ...
                            Jl. TB Simatupang Kav. 18, Jakarta Selatan ,12520</p>
                    </div>
                    <div className=" lg:col-span-2 md:col-span-4 col-span-8">
                        <h1 className="font-medium text-xl py-4">Contact</h1>
                        <p className="font-normal text-sm leading-6">
                            Email : contact@jhontracktor.co<br/>
                            Phone : (+62) 877-2469-7246</p>
                    </div>
                ...
                <div className="text-xs font-normal text-lightGray pt-10 pb-4">
                    <p className="w-full text-center">Copyright © 2023 North Craft. All Rights Reserved</p>
                </div>
            </div>
