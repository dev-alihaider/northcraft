        ...
        <div className="col-span-1 bg-blue rounded-2xl text-white sm:text-left text-center">
            <div className="large:pt-11 lg:pt-7 pt-4     large:px-16  lg:px-8 px-5">
                ...
                <div className="large:pt-10 lg:pt-6 sm:pt-4 pt-2">
                    <h1 className="font-normal large:text-xl text-lg ">
                        Our Location
                    </h1>
                ...
                <Button
                    className="transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg text-base py-3 sm:mb-12 mb-8 font-normal large:text-xl  w-full bg-darkGray large:py-6 sm:py-4 text-center rounded-2xl large:mt-10 mt-6">
                    Contact Us
                </Button>
            </div>
        </div>
